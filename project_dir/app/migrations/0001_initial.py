    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slag', models.SlugField(max_length=90, null=True, verbose_name='Url-slag')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created')),
                ('rating', models.TextField(null=True, verbose_name='Rating Of publication')),
        ...
        migrations.AddField(
            model_name='bookmark',
            name='person',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='app.person', verbose_name='Bookmark'),
        ),
    ]
